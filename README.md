...
A interface captura um CEP digitado pelo usuário, faz a chamada à API ViaCEP e exibe as informações retornadas (logradouro, bairro, cidade, estado, etc.) de forma organizada.
